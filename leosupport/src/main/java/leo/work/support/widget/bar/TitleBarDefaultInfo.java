...
public class TitleBarDefaultInfo {
    ...
    public static TitleBarDefaultInfo getTitleBarDefaultInfo() {
        if (titleBarDefaultInfo == null) {
            titleBarDefaultInfo = new TitleBarDefaultInfo(A2BSupport.dp2px(14), 0, Color.BLACK, Color.TRANSPARENT, A2BSupport.dp2px(44));
        }
...
//    public TitleBarDefaultInfo(int backImage, int titleColor, int statusBarColor, int contentHeight) {
...
//    }
    ...
    public TitleBarDefaultInfo(int defaultPadding, int backImage, int titleColor, int statusBarColor, float contentHeight) {
