...
public class TrapezoidImageView extends AppCompatImageView {
    ...
    protected void onDraw(Canvas canvas) {
        Log.e("liu0804", "onDraw    width = " + width + "    height = " + height);
        if (width >= 12 && height > 12) {
            ...
            //右下角
            {
                Log.e("liu0804", "lineTo    x = " + width + "    y = " + (height - rightBottom));


                {
                    int x1 = (int) (width * 0.9466f);
                    int y1 = (int) (width * 0.8437);
                    Log.e("liu0804", "quadTo    x1 = " + x1 + "    y1 = " + y1);
                    path.lineTo(x1, y1);
                }
                {
                    int x1 = (int) (width * 0.9136);
                    int y1 = (int) (width * 0.9595);
                    int x2 = (int) (width * 0.76f);
                    Log.e("liu0804", "quadTo    x1 = " + x1 + "    y1 = " + y1 + "    x2 = " + x2 + "    y2 = " + height);
                    path.quadTo(x1, y1, x2, height);
                }
